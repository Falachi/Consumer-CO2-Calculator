...
public class Forecasting {
    ...
    public static int ThirdOption(){
        ...
        a = JOptionPane.showOptionDialog(frame.getContentPane(), "Here are some suggestions of articles for you to read about the environment: //insert article titles only", "Results Page", 0, JOptionPane.INFORMATION_MESSAGE, null, options3, 0);
